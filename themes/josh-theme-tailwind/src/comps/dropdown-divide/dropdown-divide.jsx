...
export default function DropdownWithDivider({
      ...
      const inner = row.map((elem) => { 
        ...
        return (
          <button 
            ...
            class="w-full text-left text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1"
          >
            {elem.label}
          </button>
        );
  ...
  useClickOutside(() => {
    open && (() => {
      console.log('%cclicked outside dropdown-divide', 'color: magenta');
      closeDropdown();
    })();
  }, null, [menu, dropdown]);
  ...
  return (
      <div class="relative inline-block text-left">
        ...
        <div
          ref={menu_ref} 
          class="
            absolute right-0 z-10 mt-2 w-56 origin-top-right divide-y divide-red-500 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none
            hidden opacity-0
          "
