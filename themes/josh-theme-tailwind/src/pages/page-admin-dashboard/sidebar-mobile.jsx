...
export default function MobileSidebarDrawer({ show_mobile_menu, hideMobileMenu }) {

  return (
    <>
      {show_mobile_menu && <div class="relative z-40 lg:hidden" role="dialog" aria-modal="true">
          {/* <!--
